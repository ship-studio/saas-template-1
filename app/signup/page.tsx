      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-white">
          ...
          <p className="text-white/80 text-lg leading-relaxed mb-8">
            Join 10,000+ teams shipping faster with LaunchKit. Get access to templates, workflows, and analytics.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-[var(--border)] text-[var(--accent)] focus:ring-[var(--accent)] focus:ring-offset-0"
                required
              />
