      ...
      <Container>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="relative flex flex-col p-6 lg:p-8 rounded-2xl border border-[var(--border)] bg-[var(--background)] hover:shadow-lg hover:border-[var(--accent)]/30 transition-all duration-300"
            >
              {/* Quote mark - positioned better */}
